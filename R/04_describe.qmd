...
If we plot the distribution of gene expression values as boxplots per sample we can see that they have similar expression distributions and do not need to be normalized.
```{r}
