...
::: {.column width="50%"}
![ndg_boxplot](../results/07_neurodeg_boxplot.png){width="80%"}
:::
:::
...
::: columns
::: {.column width="50%"}
![inflam_density](../results/07_inflammatory_density.png){width="80%"}
:::

::: {.column width="50%"}
![inflam_boxplot](../results/07_inflammatory_boxplot.png){width="80%"}
:::
:::
